            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input id="email" type="email" class="form-input block w-full sm:text-sm sm:leading-5 pl-10 @error('email') pr-10 border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:shadow-outline-red @enderror" name="email" value="{{ old('email') }}" autocomplete="email" autofocus>
                        @error('email')
